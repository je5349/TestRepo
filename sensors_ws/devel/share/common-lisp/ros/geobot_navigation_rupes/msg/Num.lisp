...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name geobot_navigation_rupes-msg:<Num> is deprecated: use geobot_navigation_rupes-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_navigation_rupes-msg:num-val is deprecated.  Use geobot_navigation_rupes-msg:num instead.")
  (num m))
