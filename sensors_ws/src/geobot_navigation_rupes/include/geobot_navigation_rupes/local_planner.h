...
//os5000s_compass::compass_heading compass_msg;
...
//bool path_tracking_controller(double total_distance, double adit_direction, int mode);
...
//void get_compass(const os5000s_compass::compass_heading msg);
