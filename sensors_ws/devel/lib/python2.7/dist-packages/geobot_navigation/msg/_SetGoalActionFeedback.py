...
"""autogenerated by genpy from geobot_navigation/SetGoalActionFeedback.msg. Do not edit."""
import sys
...
class SetGoalActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "geobot_navigation/SetGoalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','geobot_navigation/SetGoalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetGoalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = geobot_navigation.msg.SetGoalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = geobot_navigation.msg.SetGoalFeedback()
