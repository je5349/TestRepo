...
"""autogenerated by genpy from gpr_gps_converge/GprConverged.msg. Do not edit."""
import sys
...
class GprConverged(genpy.Message):
  _md5sum = "faaa83bf44fd3deeece9389459e44003"
  _type = "gpr_gps_converge/GprConverged"
...
"""
  __slots__ = ['rosTime_','traceSize_','headerSize_','headerID_','stampCount_','traceNumber_','odoTick_','tracePos_','duration_','traceStatusFlag_','numStacks_','hardwareFlag_','traceData_','dataSize_','sampleInterval_','frequency_','stamp','CoordinateFormat','Longitude','Latitude','Altitude','latitude_label','longitude_label','UTMZone']
  _slot_types = ['time','int64','uint16','string','uint32','uint32','uint32','float64','float64','uint32','uint16','uint16','int16[]','int32','string','string','time','string','float64','float64','float64','string','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       rosTime_,traceSize_,headerSize_,headerID_,stampCount_,traceNumber_,odoTick_,tracePos_,duration_,traceStatusFlag_,numStacks_,hardwareFlag_,traceData_,dataSize_,sampleInterval_,frequency_,stamp,CoordinateFormat,Longitude,Latitude,Altitude,latitude_label,longitude_label,UTMZone
    ...
    """
    if args or kwds:
      super(GprConverged, self).__init__(*args, **kwds)
