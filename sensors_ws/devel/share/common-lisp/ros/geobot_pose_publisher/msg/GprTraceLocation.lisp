...
(cl:in-package geobot_pose_publisher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <GprTraceLocation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GprTraceLocation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name geobot_pose_publisher-msg:<GprTraceLocation> is deprecated: use geobot_pose_publisher-msg:GprTraceLocation instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:stamp-val is deprecated.  Use geobot_pose_publisher-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'CoordinateFormat-val :lambda-list '(m))
(cl:defmethod CoordinateFormat-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:CoordinateFormat-val is deprecated.  Use geobot_pose_publisher-msg:CoordinateFormat instead.")
  (CoordinateFormat m))

(cl:ensure-generic-function 'Longitude-val :lambda-list '(m))
(cl:defmethod Longitude-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:Longitude-val is deprecated.  Use geobot_pose_publisher-msg:Longitude instead.")
  (Longitude m))

(cl:ensure-generic-function 'Latitude-val :lambda-list '(m))
(cl:defmethod Latitude-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:Latitude-val is deprecated.  Use geobot_pose_publisher-msg:Latitude instead.")
  (Latitude m))

(cl:ensure-generic-function 'Altitude-val :lambda-list '(m))
(cl:defmethod Altitude-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:Altitude-val is deprecated.  Use geobot_pose_publisher-msg:Altitude instead.")
  (Altitude m))

(cl:ensure-generic-function 'latitude_label-val :lambda-list '(m))
(cl:defmethod latitude_label-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:latitude_label-val is deprecated.  Use geobot_pose_publisher-msg:latitude_label instead.")
  (latitude_label m))

(cl:ensure-generic-function 'longitude_label-val :lambda-list '(m))
(cl:defmethod longitude_label-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:longitude_label-val is deprecated.  Use geobot_pose_publisher-msg:longitude_label instead.")
  (longitude_label m))

(cl:ensure-generic-function 'UTMZone-val :lambda-list '(m))
(cl:defmethod UTMZone-val ((m <GprTraceLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geobot_pose_publisher-msg:UTMZone-val is deprecated.  Use geobot_pose_publisher-msg:UTMZone instead.")
  (UTMZone m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GprTraceLocation>)))
  ...
  "geobot_pose_publisher/GprTraceLocation")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GprTraceLocation)))
  "Returns string type for a message object of type 'GprTraceLocation"
  "geobot_pose_publisher/GprTraceLocation")
