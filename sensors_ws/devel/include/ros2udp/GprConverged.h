// Generated by gencpp from file ros2udp/GprConverged.msg
// DO NOT EDIT!


#ifndef ROS2UDP_MESSAGE_GPRCONVERGED_H
#define ROS2UDP_MESSAGE_GPRCONVERGED_H
...
struct GprConverged_
{
  ...
  typedef boost::shared_ptr< ::ros2udp::GprConverged_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros2udp::GprConverged_<ContainerAllocator> const> ConstPtr;

}; // struct GprConverged_

typedef ::ros2udp::GprConverged_<std::allocator<void> > GprConverged;

typedef boost::shared_ptr< ::ros2udp::GprConverged > GprConvergedPtr;
typedef boost::shared_ptr< ::ros2udp::GprConverged const> GprConvergedConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros2udp::GprConverged_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros2udp::GprConverged_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros2udp::GprConverged_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros2udp::GprConverged_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros2udp::GprConverged_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros2udp::GprConverged_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros2udp::GprConverged_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros2udp::GprConverged_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros2udp::GprConverged_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros2udp::GprConverged_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfaaa83bf44fd3deeULL;
  static const uint64_t static_value2 = 0xece9389459e44003ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros2udp::GprConverged_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros2udp/GprConverged";
  }
...
template<class ContainerAllocator>
struct Definition< ::ros2udp::GprConverged_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros2udp::GprConverged_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros2udp::GprConverged_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros2udp::GprConverged_<ContainerAllocator>& v)
  {
    s << indent << "rosTime_: ";
...
#endif // ROS2UDP_MESSAGE_GPRCONVERGED_H
