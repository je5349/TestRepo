...
"""autogenerated by genpy from geobot_navigation/SetGoalActionGoal.msg. Do not edit."""
import sys
...
class SetGoalActionGoal(genpy.Message):
  _md5sum = "afd96e4a34a69ea5ef07941841344f11"
  _type = "geobot_navigation/SetGoalActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','geobot_navigation/SetGoalGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetGoalActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = geobot_navigation.msg.SetGoalGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = geobot_navigation.msg.SetGoalGoal()
