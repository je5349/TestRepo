...
//#include <robust_navigation/SetGoal.h>
#include <robust_navigation/SetGoalAction.h>
#include <actionlib/server/simple_action_server.h>
#include <tf/transform_listener.h>
#include <gap_finding_pkg/GapArray.h>
#include <pointcloud_to_laserscan/ObstacleProximity.h>
#include <sensor_msgs/Joy.h>
#include <robust_navigation/navsat_conversions.h>
...
double error_gain, cte_gain, heading_gain, derivative_gain, steering_gain, derivative_heading_gain;
...
bool override_by_joystick, pathIsAvailable;

ros::NodeHandle nh;
ros::NodeHandle nhPriv;
ros::Subscriber pathSubscriber_, obstacle_proximitySubscriber_, gap_arraySubscriber_, joystickoverideSubscriber_;
ros::Publisher velocity_cmdPublisher_, local_pathPublisher_, alternate_pathPublisher_;
ros::ServiceServer move2goal_;
ros::ServiceClient makeplan_;
actionlib::SimpleActionServer<robust_navigation::SetGoalAction> move2goal_action_; 
...
bool run(const robust_navigation::SetGoalGoalConstPtr& req); //for action
