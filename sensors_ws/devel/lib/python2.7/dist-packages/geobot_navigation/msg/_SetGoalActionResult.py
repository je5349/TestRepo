...
"""autogenerated by genpy from geobot_navigation/SetGoalActionResult.msg. Do not edit."""
import sys
...
class SetGoalActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "geobot_navigation/SetGoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','geobot_navigation/SetGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = geobot_navigation.msg.SetGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = geobot_navigation.msg.SetGoalResult()
